 ...
 * @subpackage Mwb_Cf7_Integration_With_Salesforce_Crm/public/partials
 */
...
<html lang="en">
	<head>
		...
		<title><?php echo esc_html__( 'Error - ', 'mwb-cf7-integration-with-salesforce-crm' ); ?><?php echo esc_html( ! empty( $data['title'] ) ? $data['title'] : '' ); ?></title>
	</head>
	<body>
		<table>
			<tr>
				<td style="font-family: sans-serif;background-color: #1f1f1f; height: 36px; color: #fff; font-size: 24px; padding: 0px 10px">
				<?php echo esc_html__( 'Error - ', 'mwb-cf7-integration-with-salesforce-crm' ); ?>
										...
										<?php if ( 'Logs' == $k ) : ?>
											<tr>
												...
												<td style="padding-top: 10px;color: #303030;font-family: Helvetica;font-size: 13px;line-height: 150%;text-align: left; word-break:break-all;">
													<a href="<?php echo esc_url( $v ); ?>" target="_blank"><?php echo esc_html__( 'View Logs', 'mwb-cf7-integration-with-salesforce-crm' ); ?></a>
												</td>
											</tr>
										<?php else : ?>
											<tr>
