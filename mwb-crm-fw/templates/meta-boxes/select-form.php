...
<div class="mwb-feeds__content  mwb-content-wrap">
	<a class="mwb-feeds__header-link active">
		<?php esc_html_e( 'Select CF7 Form', 'mwb-cf7-integration-with-salesforce-crm' ); ?>
	</a>
		...
		<div class="mwb-feeds__meta-box-wrap">
			<div class="mwb-form-wrapper">
				<select name="crm_form" id="mwb-<?php echo esc_attr( $this->crm_slug ); ?>-cf7-select-form" class="mwb-form__dropdown">
					<option value="-1"><?php esc_html_e( 'Select Form', 'mwb-cf7-integration-with-salesforce-crm' ); ?></option>
					<optgroup label="<?php esc_html_e( 'Contact Form 7', 'mwb-cf7-integration-with-salesforce-crm' ); ?>" ></optgroup>
