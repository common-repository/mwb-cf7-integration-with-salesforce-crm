 ...
 */
class Mwb_Cf7_Integration_Connect_Framework {
	...
	public function get_avialable_form_filters() {
		...
		$filter = array(
			'exact_match'       => esc_html__( 'Matches exactly', 'mwb-cf7-integration-with-salesforce-crm' ),
			'no_exact_match'    => esc_html__( 'Does not match exactly', 'mwb-cf7-integration-with-salesforce-crm' ),
			'contains'          => esc_html__( 'Contains (Text)', 'mwb-cf7-integration-with-salesforce-crm' ),
			'not_contains'      => esc_html__( 'Does not contain (Text)', 'mwb-cf7-integration-with-salesforce-crm' ),
			'exist'             => esc_html__( 'Exist in (Text)', 'mwb-cf7-integration-with-salesforce-crm' ),
			'not_exist'         => esc_html__( 'Does not Exists in (Text)', 'mwb-cf7-integration-with-salesforce-crm' ),
			'starts'            => esc_html__( 'Starts with (Text)', 'mwb-cf7-integration-with-salesforce-crm' ),
			'not_starts'        => esc_html__( 'Does not start with (Text)', 'mwb-cf7-integration-with-salesforce-crm' ),
			'ends'              => esc_html__( 'Ends with (Text)', 'mwb-cf7-integration-with-salesforce-crm' ),
			'not_ends'          => esc_html__( 'Does not end with (Text)', 'mwb-cf7-integration-with-salesforce-crm' ),
			'less_than'         => esc_html__( 'Less than (Text)', 'mwb-cf7-integration-with-salesforce-crm' ),
			'greater_than'      => esc_html__( 'Greater than (Text)', 'mwb-cf7-integration-with-salesforce-crm' ),
			'less_than_date'    => esc_html__( 'Less than (Date/Time)', 'mwb-cf7-integration-with-salesforce-crm' ),
			'greater_than_date' => esc_html__( 'Greater than (Date/Time)', 'mwb-cf7-integration-with-salesforce-crm' ),
			'equal_date'        => esc_html__( 'Equals (Date/Time)', 'mwb-cf7-integration-with-salesforce-crm' ),
			'empty'             => esc_html__( 'Is empty', 'mwb-cf7-integration-with-salesforce-crm' ),
			'not_empty'         => esc_html__( 'Is not empty', 'mwb-cf7-integration-with-salesforce-crm' ),
		);
	...
	public function get_available_crm_objects() {
		...
		$crm_objects = esc_html__( 'Application is not connected to Salesforce', 'mwb-cf7-integration-with-salesforce-crm' );
	...
	public function get_connection_method() {
		$active = get_option( 'mwb-' . $this->crm_slug . '-cf7-active', false );
		$result = false;

		if ( $active ) {
			$method = get_option( 'mwb-' . $this->crm_slug . '-cf7-integration-method', false );
			if ( $method ) {
				$result = $method;
			}
		}
