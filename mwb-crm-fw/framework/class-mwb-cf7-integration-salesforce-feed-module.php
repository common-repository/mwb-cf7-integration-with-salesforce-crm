 ...
 * @author     MakeWebBetter <https://makewebbetter.com>
 */
class Mwb_Cf7_Integration_Salesforce_Feed_Module {
	...
	public function register_feeds_post_type() {
		...
		$labels = array(
			'name'               => _x( 'Feeds', 'Post Type General Name', 'mwb-cf7-integration-with-salesforce-crm' ),
			'singular_name'      => _x( 'Feed', 'Post Type Singular Name', 'mwb-cf7-integration-with-salesforce-crm' ),
			'menu_name'          => _x( 'Crm Feeds', 'Admin menu name', 'mwb-cf7-integration-with-salesforce-crm' ),
			'parent_item_colon'  => __( 'Parent Feed', 'mwb-cf7-integration-with-salesforce-crm' ),
			'all_items'          => __( 'All Feeds', 'mwb-cf7-integration-with-salesforce-crm' ),
			'view_item'          => __( 'View Feed', 'mwb-cf7-integration-with-salesforce-crm' ),
			'add_new_item'       => __( 'Add New Feed', 'mwb-cf7-integration-with-salesforce-crm' ),
			'add_new'            => __( 'Add New', 'mwb-cf7-integration-with-salesforce-crm' ),
			'edit_item'          => __( 'Edit Feed', 'mwb-cf7-integration-with-salesforce-crm' ),
			'update_item'        => __( 'Update Feed', 'mwb-cf7-integration-with-salesforce-crm' ),
			'search_items'       => __( 'Search Feed', 'mwb-cf7-integration-with-salesforce-crm' ),
			'not_found'          => __( 'Not Found', 'mwb-cf7-integration-with-salesforce-crm' ),
			'not_found_in_trash' => __( 'Not found in Trash', 'mwb-cf7-integration-with-salesforce-crm' ),
		);

		$args = array(
			'label'                => __( 'Feeds', 'mwb-cf7-integration-with-salesforce-crm' ),
			'description'          => __( 'Feeds for crm', 'mwb-cf7-integration-with-salesforce-crm' ),
			'labels'               => $labels,
	...
	public function add_feed_meta_box() {
		...
		global $post;
		$dependent = $this->fetch_feed_data( $post->ID, 'mwb-' . $this->crm_slug . '-cf7-dependent-on', false );
		$metaboxes = array();

		$metaboxes[] = array(
			'slug'     => 'mwb_' . $this->crm_slug . '_cf7_feeds_meta_box',
			'title'    => esc_html__( 'Feed details', 'mwb-cf7-integration-with-salesforce-crm' ),
		...
		if ( ! $dependent ) {
			$metaboxes[] = array(
				...
				'title'    => esc_html__( 'Conditional Statements', 'mwb-cf7-integration-with-salesforce-crm' ),
